/*
envioSignal.c
Compilación: gcc -o envioSignal envioSignal.c
...
int main(int argc, char *argv[]) {
	 ...
	 * 
	 * Envía una señal a un proceso <pid>
	 */	
	switch(signal) {
		case 0: //SIGTERM -> Señal de terminación
			kill(pid,SIGTERM); break;
		case 1: //SIGUSR1 -> Señal definida por el usuario (1)
			kill(pid,SIGUSR1); break;
		case 2: //SIGUSR2 -> Señal definida por el usuario (2)
