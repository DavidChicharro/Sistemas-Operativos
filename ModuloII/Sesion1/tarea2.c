/*
tarea2.c
Compilación: gcc -o tarea2 tarea2.c
...
int main(int argc, char *argv[]){
	...
	for(i=1 ; i<argc ; i++) {
		...
		apunta statbuf. No se requieren permisos en el archivo en sí, 
		pero, en el caso de lstat(), se requiere permiso de ejecución 
		(búsqueda) en todos los directorios en la ruta que conducen al archivo.
		*/
...
/*
 * Para cada archivo dado como argumento del programa
 * se muestra el tipo de archivo del que se trata
 */